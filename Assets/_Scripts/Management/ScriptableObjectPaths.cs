...
public static class ScriptableObjectPaths {
	...
	public const string ScriptableObjectDirectoryName = "ScriptableObjects/";
	...
	public const string EquipmentPath = ScriptableObjectDirectoryName + EquipmentDirectoryName; 
	public const string WeaponsPath = EquipmentPath + WeaponsDirectoryName;
	...
	public const string ArmorPath = EquipmentPath + ArmorDirectoryName;
	...
	public const string PlayerCharacterPath = ScriptableObjectDirectoryName + "PlayerCharacters/";
}
